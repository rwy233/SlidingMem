...
#ifndef SLIDINGMEM_SLIDINGBLOOMOPT_H
#define SLIDINGMEM_SLIDINGBLOOMOPT_H

#include "common/Abstract.h"
#include "common/bitset.h"

template<typename DATA_TYPE>
class SlidingBloomOpt : public Abstract<DATA_TYPE>{
public:

    SlidingBloomOpt(uint64_t memory, uint64_t _HASH_NUM, uint64_t _CYCLE):
